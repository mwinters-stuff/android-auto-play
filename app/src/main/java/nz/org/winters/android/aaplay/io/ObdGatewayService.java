...
import nz.org.winters.android.aaplay.R;
...
public class ObdGatewayService extends AbstractGatewayService {
  ...
  public void startService() throws IOException {
    ...
    final String remoteDevice = appSettings.bluetoothAdapter().get();
    if (TextUtils.isEmpty(remoteDevice)) {
      Toast.makeText(getApplicationContext(), getString(R.string.no_bluetooth_device), Toast.LENGTH_LONG).show();
      ...
      showNotification(getString(R.string.notification_action), getString(R.string.service_starting), R.drawable.ic_bluetooth_black_24dp, true, true, false);
      ...
      showNotification(getString(R.string.notification_action), getString(R.string.service_started), R.drawable.ic_bluetooth_black_24dp, true, true, false);
    }
  }
